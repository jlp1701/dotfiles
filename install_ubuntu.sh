...
sudo apt update
sudo apt install curl firefox gimp git moreutils python3 python3-pip python3-setuptools stow texlive-full
echo "done."
...
ln -s ~/repos/git-summary/git-summary /usr/local/bin/git-summary
